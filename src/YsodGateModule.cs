...
namespace Contoso.IIS
{
    ...
    ///
    /// Config (appSettings in root web.config):
    ///   TrustedProxies         - comma-separated exact IPv4 addresses of HAProxy nodes
    ///   InternalClientSubnets  - comma-separated CIDR ranges allowed to see full detail
    ///
    /// Depends on: System.Web, System.Configuration (both in the GAC)
    /// Deployed via: GAC + root web.config module registration
    /// </summary>
    public class YsodGateModule : IHttpModule
    {
        ...
        private void OnError(object sender, EventArgs e)
        {
            ...
            // TrySkipIisCustomErrors prevents IIS's native error pages from
            // replacing our response body on 500 status codes.
        ...
        private sealed class Cidr
        {
            ...
            {
                // IPv4 only. IPv6 addresses return false rather than throwing.
            ...
            public static bool TryParse(string cidr, out Cidr result)
            {
                ...
                // prefix 0 = match anything; shift of 32 is undefined in C#,
